<?php $__env->startSection('title','MTS - Editando: '.$event->title); ?>
        ...
        <form action="/events/update/<?php echo e($event->id); ?>" method="POST" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <select id="private" name="private" class="form-control">
                    ...
                    <option value="1"<?php echo e($event->private == 1 ? "selected='selected'":""); ?>>Privado</option>
                </select>
            </div>

            <div class="form-group">
                <label for="title" class="">Descrição: </label>
                <textarea name="description" id="description" class="form-control" placeholder="Descrição do Evento" value="<?php echo e($event->description); ?>"><?php echo e($event->description); ?></textarea>
            </div>
            ...
            <input class="btn btn-success" type="submit" value="EditarEvento">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelEstudo\Laravel-Eventos\gerenciador-eventos\resources\views/events/edit.blade.php ENDPATH**/ ?>